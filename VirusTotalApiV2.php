...
//		print('<pre>');
		//print($result->scans);
echo '<section id="footer" class="section pad-bot30 ">';
...
echo					'<div class="align-center">';
						echo'<i class="fa fa-eye fa-10x mar-bot20"></i>';
						echo'<h4 class="text-bold">Report</h4>';
						//echo'<p>Lorem ipsum dolor sit amet, mutat graeco volumus ad eam, singulis patrioque comprehensam nam no. </p>';
					echo'</div>';
				echo'</div>';				
		...
		echo'</section>';
							  ...
							  {
								  echo '<section id="section-services" class="section bg-white">';
echo		'<div class="container">'; 
...
echo					'<div class="align-center">';
	...
	echo'</div>	';
		...
		echo'</section>';
						...
						echo '	<a href="#header" class="scrollup"><i class="fa fa-chevron-up"></i></a>	'	;  
